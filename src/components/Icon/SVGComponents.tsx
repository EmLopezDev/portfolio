...
export function Bluesky({ fill, size, className }: SVGType) {
    return (
        ...
        >
            <path d="M10.8576 3.06895C16.1772 7.11915 21.8992 15.3313 24 19.7383C26.1009 15.3316 31.8225 7.11906 37.1424 3.06895C40.9808 0.146493 47.2 -2.11474 47.2 5.08062C47.2 6.51763 46.3876 17.1523 45.9111 18.8788C44.2548 24.8812 38.2196 26.4122 32.8511 25.4856C42.2351 27.1053 44.6223 32.4704 39.4668 37.8355C29.6756 48.0249 25.394 35.279 24.2964 32.013C24.0953 31.4143 24.0012 31.1342 23.9998 31.3723C23.9984 31.1342 23.9043 31.4143 23.7032 32.013C22.6061 35.279 18.3246 48.0252 8.5328 37.8355C3.37728 32.4704 5.7644 27.105 15.1486 25.4856C9.77992 26.4122 3.74456 24.8812 2.08856 18.8788C1.61207 17.1521 0.799683 6.51747 0.799683 5.08062C0.799683 -2.11474 7.01904 0.146493 10.8573 3.06895H10.8576Z" />
        </svg>
    );
}
